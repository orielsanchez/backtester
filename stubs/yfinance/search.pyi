...
class Search:
    ...
    def __init__(self, query, max_results: int = 8, news_count: int = 8, lists_count: int = 8, include_cb: bool = True, include_nav_links: bool = False, include_research: bool = False, include_cultural_assets: bool = False, enable_fuzzy_query: bool = False, recommended: int = 8, session: Incomplete | None = None, proxy: Incomplete | None = None, timeout: int = 30, raise_errors: bool = True) -> None: ...
